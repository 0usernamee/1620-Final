...
/* PLAN
for add user color use a readline question for user input then use a .push to push the input and console.log it to notify the user then call the startApp. for dispay colors use a key for the color status then console.log the color and its status, and then cal startApp.
